									...
									<div className="tf-mini-cart-sroll">
										...
										<div className="tf-minicart-recommendations">
											<div className="tf-minicart-recommendations-heading">
												...
												<div className="sw-dots small style-2 cart-slide-pagination spdsc1 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
													<span className="swiper-pagination-bullet swiper-pagination-bullet-active" />
													<span className="swiper-pagination-bullet" />
												</div>
											</div>
											<div
												className="swiper swiper-initialized swiper-horizontal tf-cart-slide swiper-backface-hidden"
												dir="ltr"
											>
												<div
